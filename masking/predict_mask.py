def predict_mask(
    ...
    # need to unpad on the z-axis to the original shape:
    diff = mask_pred.shape[0] - in_file_data.shape[0]
    mask_pred = mask_pred[diff // 2:  in_file_data.shape[0] + diff // 2, :, :]

    # removing predictions that are not attached to the main segmentation
